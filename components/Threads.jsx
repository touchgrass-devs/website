...
// Adapted from react-bits' Threads component. Mouse interaction has been
// stripped out entirely per project request - this is a pure ambient
// background, not something a visitor is meant to interact with.
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        // Fixed at center - no pointer tracking, this is a static ambient uniform.
